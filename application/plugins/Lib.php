    ...
    public static function upload($destination) {
        ...
        */
        ...
        try {
            ...
            $targetDir = realpath($config->site->path->upload) . DIRECTORY_SEPARATOR;
            ...
            if ($cleanupTargetDir && is_dir($targetDir) && ($dir = opendir($targetDir))) {
                ...
                $response["message"] = "Failed to open temp directory.";
                $response["code"] = 100;
            ...
            $filePathDestination = $destination.DIRECTORY_SEPARATOR.$base;
            ...
            if (!$move) {                
                ...
                $response["success"] = false;
                $response["message"] = "Failed to move file to destination: $filePathDestination";
                $response["code"] = 104;                
            } else {
                $filedetails = array();
                $filedetails["name"] = $fileName;
                $filedetails["extension"] = $ext;
                $filedetails["base"] = $base;
                $path = array();
                $path["source"] = $filePath;
                $path["destination"] = $filePathDestination;
